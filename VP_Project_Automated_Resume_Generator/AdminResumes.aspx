<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminResumes.aspx.cs" Inherits="VP_Project_Automated_Resume_Generator.AdminResumes" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Admin - View Resumes</title>
    <style>
        :root {
            --primary: #6c5ce7;
    ...
    <div class="resumes-container">
        <div class="resumes-card">
            <div class="resumes-header">
                <h2><i class="bi bi-file-earmark-text-fill"></i> Resume Management</h2>
                <p>View and manage all resumes created in the system</p>
            </div>
            
            <div style="padding: 2rem;">
                <asp:GridView ID="gvResumes" runat="server" AutoGenerateColumns="False" CssClass="resumes-grid"
                    EmptyDataText="No resumes found in the system." EmptyDataRowStyle-CssClass="empty-state">
                    <Columns>
                        ...
                        <asp:BoundField DataField="CreatedAt" HeaderText="Created On" DataFormatString="{0:MM/dd/yyyy}" />
