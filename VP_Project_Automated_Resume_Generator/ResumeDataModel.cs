...
{
    /// <summary>
    /// Canonical data shape that every template renderer, DOCX builder, and ATS scorer
    /// operates on. Replaces the previous flat Resume / DraftResumeData string bags
    /// for structured features (JD matching, real DOCX, structured optional sections).
    /// </summary>
